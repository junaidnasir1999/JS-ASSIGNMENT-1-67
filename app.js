...
imgArray[5].src = 'img/Gallery/poza5.jpg';

imgArray[6] = new Image();
imgArray[6].src = 'img/Gallery/poza6.jpg';

imgArray[7] = new Image();
imgArray[7].src = 'img/Gallery/poza7.jpg';

imgArray[8] = new Image();
imgArray[8].src = 'img/Gallery/poza8.jpg';

imgArray[9] = new Image();
imgArray[9].src = 'img/Gallery/poza9.jpg';

imgArray[10] = new Image();
imgArray[10].src = 'img/Gallery/poza10.jpg';

imgArray[11] = new Image();
imgArray[11].src = 'img/Gallery/poza11.jpg';


imgArray[12] = new Image();
imgArray[12].src = 'img/Gallery/poza12.jpg';


imgArray[13] = new Image();
imgArray[13].src = 'img/Gallery/poza13.jpg';


imgArray[14] = new Image();
imgArray[14].src = 'img/Gallery/poza14.jpg';

imgArray[15] = new Image();
imgArray[15].src = 'img/Gallery/poza15.jpg';
...
div.setAttribute("style", "display:block; color:red");
       ...
       var result = document.getElementById("main-content");
        ...
        function myFunction() {
        document.getElementById("f-name").value="Junaid";
        document.getElementById("l-name").value="Nasir";
        document.getElementById("email").value="JunaidNasir56@gmail.com";
        }
